...
| `HERMES_WEBUI_MAX_UPLOAD_MB` | `500` | Maximum upload size in MB; frontend preflight, backend limit, archive extraction guard, and upload timeout all derive from this |
