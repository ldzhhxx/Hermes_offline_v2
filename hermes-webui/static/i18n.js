...
const LOCALES = {
  en: {
    ...
    mcp_restart_hint: '服务器变更目前在此处为只读。请编辑 config.yaml 并重启 Hermes 后生效。',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_preferences_meta: 'Hermes Web UI 的默认值和界面行为。',
    ...
    kanban_work_queue_hint: '这是 Hermes Agent 工作队列。创建或分诊任务，分配负责人，将任务移动到 Ready，然后由调度器领取。',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_desc_voice_mode: '在听写麦克风旁显示语音模式按钮（音频波形）。你可以自然说话，Hermes 会在停顿后自动发送并朗读回复。需要浏览器同时支持语音识别和 TTS。',
