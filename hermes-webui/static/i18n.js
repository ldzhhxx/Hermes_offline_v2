...
const LOCALES = {
  en: {
    ...
    offline_network_detail: 'DiAgent is unreachable from this browser right now.',
    offline_autorefresh: 'I will refresh this page automatically when DiAgent is reachable again.',
    ...
    mcp_restart_hint: '服务器变更目前在此处为只读。请编辑 config.yaml 并重启 DiAgent 后生效。',
    mcp_toggle_followup: '启用/停用控件暂不开放，等待 MCP 重载语义明确后再支持。',
    mcp_status_active: '活动',
    ...
    mcp_tools_desc: '搜索活动 MCP 服务器中的已知工具。',
    mcp_tools_search_placeholder: '按名称、服务器或描述搜索工具…',
    mcp_tools_no_tools: '当前运行时清单中没有可用的 MCP 工具。',
    mcp_tools_no_matches: '没有匹配搜索条件的 MCP 工具。',
    mcp_tools_load_failed: '加载 MCP 工具失败。',
    mcp_tools_schema_empty: '没有 schema 参数。',
    mcp_tools_runtime_note: '工具清单仅使用已知的活动 MCP 运行时数据；WebUI 不会启动或探测服务器。',
    // PDF preview (#480)
    ...
    session_jump_start_label: '跳到会话开头',
    session_jump_end: '末尾',
    session_jump_end_label: '跳到会话末尾',
    ...
    cmd_skills: 'List available DiAgent skills',
  ...
  cmd_btw_usage:'/btw <question> — ask a side question using session context',
   ...
   cmd_branch:'将此对话分叉为新会话',
   cmd_branch_usage:'/branch [名称] — 分叉当前对话（可选名称）',
   branch_forked:'已分叉为新会话',
   branch_failed:'分叉失败：',
  ...
  status_agent_running:'Agent running',
    status_profile: '配置档',
    status_hermes_home: 'DiAgent 主目录',
    status_started: '已启动',
    status_updated: '已更新',
    status_tokens: 'Token',
    status_ephemeral: '临时快照 — 不会保存到转写历史。',
  ...
  untitled:'Untitled',
    ...
    workspace_show_hidden_files_desc: '在文件树中包含 .DS_Store、.git、node_modules 以及其他隐藏/系统文件。',
    workspace_hidden_files_visible: '隐藏文件可见',
    workspace_hidden_files_visible_title: '隐藏文件当前可见 — 点击查看选项',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_heading_subtitle: '偏好、对话工具和系统控制。',
    ...
    settings_section_preferences_meta: 'DiAgent Web UI 的默认值和界面行为。',
    ...
    settings_desc_session_jump_buttons: '阅读长会话历史时显示浮动的开头和末尾按钮。',
    ...
    cmd_reasoning: '切换思考过程显示/隐藏，设置推理强度，或查看当前状态',
    ...
    kanban_all_assignees: '全部负责人',
    kanban_all_tenants: '全部租户',
    kanban_include_archived: '包含已归档',
    kanban_no_matching_tasks: '没有匹配任务',
    kanban_no_data: '暂无看板数据',
    kanban_work_queue_hint: '这是 DiAgent 工作队列。创建或分诊任务，分配负责人，将任务移动到 Ready，然后由调度器领取。',
    ...
    kanban_refresh: '刷新',
    kanban_status_triage: '分诊',
    kanban_status_todo: '待办',
    kanban_status_ready: '就绪',
    kanban_status_running: '运行中',
    ...
    kanban_parents: '父任务',
    kanban_children: '子任务',
    kanban_runs_count: '运行记录（{0}）',
    kanban_no_comments: '暂无评论',
    kanban_no_events: '暂无事件',
    kanban_no_runs: '暂无运行记录',
    kanban_new_task: '新任务',
    kanban_add_comment: '添加评论',
      kanban_only_mine: '只看我的',
      kanban_bulk_action: '批量操作',
      kanban_nudge_dispatcher: '预览调度器',
      kanban_stats: '统计',
      kanban_worker_log: '工作器日志',
      kanban_block: '阻塞',
      kanban_unblock: '解除阻塞',
      kanban_back_to_board: '返回看板',
      kanban_lanes_by_profile: '按配置档分泳道',
      kanban_new_board: '新建看板…',
      kanban_rename_board: '重命名当前看板…',
      kanban_archive_board: '归档当前看板…',
      kanban_archive_board_confirm: '归档看板“{name}”？任务仍会保留在磁盘，可从 kanban/boards/_archived/ 恢复。',
      kanban_board_archived: '看板已归档',
      kanban_board_name: '名称',
      kanban_board_slug: 'Slug（小写字母和连字符）',
      kanban_board_description: '描述（可选）',
      kanban_board_icon: '图标（emoji，可选）',
      kanban_board_color: '颜色（可选）',
      kanban_board_name_required: '名称不能为空',
      kanban_board_slug_required: 'Slug 不能为空',
    ...
    tab_dashboard: 'DiAgent Dashboard',
    ...
    settings_desc_voice_mode: 'Show the voice-mode button (audio waveform) next to the dictation mic. Lets you speak naturally — DiAgent auto-sends after a pause and reads replies aloud. Requires a browser that supports both speech recognition and TTS.',
    ...
    settings_desc_sync_insights: 'Mirrors WebUI token usage to state.db so the CLI /insights command includes browser session data. Off by default.',
    ...
    settings_desc_bot_name: 'Display name for the assistant throughout the UI. Defaults to DiAgent.',
    ...
    providers_section_meta: '管理 AI 提供商 API key。修改会立即生效。',
    providers_status_configured: '已配置 API key',
    providers_status_not_configured: '未配置 API key',
    providers_status_oauth: 'OAuth',
    providers_status_api_key: 'API key',
    providers_status_not_configured_label: '未配置',
    providers_oauth_hint: '已通过 OAuth 认证，无需 API key。',
    providers_oauth_config_yaml_hint: 'Token 已通过 config.yaml 配置。如需更新，请编辑 config.yaml 的 providers 部分或运行 hermes auth。',
    providers_oauth_not_configured_hint: '尚未认证。请在终端运行 hermes auth 配置此提供商。',
    providers_save: '保存',
    providers_remove: '移除',
    providers_saving: '保存中…',
    providers_removing: '移除中…',
    providers_enter_key: '请输入 API key',
    providers_empty: '没有可配置的提供商。',
    providers_key_updated: 'API key 已保存',
    providers_key_removed: 'API key 已移除',
    providers_key_placeholder_new: 'sk-...',
    providers_key_placeholder_replace: '输入新 key 以替换…',
    cancel: 'Cancel',
    ...
    onboarding_title: 'Welcome to DiAgent Web UI',
    onboarding_lead: 'A quick guided setup will verify DiAgent, save a real provider configuration, choose a workspace and model, and optionally protect the app with a password.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip setup',
    onboarding_skipped: 'Setup skipped — using existing config.',
    onboarding_open: 'Open DiAgent',
    onboarding_step_system_title: 'System check',
    onboarding_step_system_desc: 'Verify DiAgent and config visibility.',
    onboarding_step_setup_title: 'Provider setup',
    onboarding_step_setup_desc: 'Save the minimum DiAgent provider config.',
    ...
    onboarding_notice_system_ready: 'DiAgent looks reachable from the Web UI.',
    onboarding_notice_system_unavailable: 'DiAgent is not fully available yet. Bootstrap can install it, but provider setup may still require a terminal.',
    onboarding_check_agent: 'DiAgent',
    ...
    onboarding_notice_setup_required: 'Choose a simple provider path here. Advanced OAuth flows still belong in the DiAgent CLI for now.',
    onboarding_notice_setup_already_ready: 'A working DiAgent provider setup is already detected. You can keep it or replace it here.',
    onboarding_oauth_provider_ready_title: 'Provider already authenticated',
    onboarding_oauth_provider_ready_body: 'This instance is configured to use an OAuth provider (<strong>{provider}</strong>) that was set up via the DiAgent CLI. No API key is needed here — click Continue to finish setup.',
    ...
    onboarding_api_key_help_prefix: 'Saved as a secret in your DiAgent .env file using',
    ...
    onboarding_workspace_help: 'Pick the model DiAgent should use for new chats after setup completes.',
  ...
  ja: {
    ...
    offline_network_detail: '現在、このブラウザからDiAgentに到達できません。',
    offline_autorefresh: 'DiAgentに再接続できたら、このページを自動的に更新します。',
    ...
    mcp_restart_hint: 'ここでのサーバー変更は現状読み取り専用です。反映するには config.yaml を編集して DiAgent を再起動してください。',
    ...
    cmd_skills: '利用可能な DiAgent スキルを一覧表示',
  ...
  status_agent_running:'エージェント実行中',
    ...
    status_hermes_home: 'DiAgent ホーム',
    status_started: '開始',
    status_tokens: 'トークン',
    status_updated: '更新',
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_section_preferences_meta: 'DiAgent Web UI のデフォルトと UI 動作。',
    ...
    kanban_work_queue_hint: 'これは DiAgent のワークキューです。タスクを作成またはトリアージし、担当者を割り当て、Ready に移動すると、ディスパッチャーがそれをクレームします。',
    ...
    settings_desc_sync_insights: 'WebUI のトークン使用量を state.db にミラーし、CLI /insights コマンドにブラウザセッションのデータを含めます。デフォルトはオフ。',
    settings_desc_check_updates: 'WebUI または Agent の新しいバージョンが利用可能な時にバナーを表示します。バックグラウンドで定期的に git fetch を実行します。',
    settings_desc_bot_name: 'UI 全体で表示されるアシスタントの名前。デフォルトは DiAgent。',
    ...
    onboarding_lead: 'クイックガイドで DiAgent を確認し、プロバイダ設定を保存し、ワークスペースとモデルを選択し、必要ならパスワードでアプリを保護します。',
    onboarding_back: '戻る',
    onboarding_continue: '続ける',
    onboarding_skip: 'セットアップをスキップ',
    onboarding_skipped: 'セットアップをスキップ — 既存設定を使用します。',
    onboarding_open: 'DiAgent を開く',
    onboarding_step_system_title: 'システム確認',
    onboarding_step_system_desc: 'DiAgent と設定の可視性を確認します。',
    onboarding_step_setup_title: 'プロバイダ設定',
    onboarding_step_setup_desc: '最低限の DiAgent プロバイダ設定を保存します。',
    ...
    onboarding_notice_system_ready: 'Web UI から DiAgent へ到達できそうです。',
    onboarding_notice_system_unavailable: 'DiAgent はまだ完全には利用できません。Bootstrap でインストールできますが、プロバイダ設定にはターミナルが必要な場合があります。',
    onboarding_check_agent: 'DiAgent',
    ...
    onboarding_notice_setup_required: 'シンプルなプロバイダ経路をここで選んでください。高度な OAuth フローは現状 DiAgent CLI 側で扱います。',
    onboarding_notice_setup_already_ready: '動作する DiAgent プロバイダ設定が既に検出されています。維持するか、ここで置き換えできます。',
    onboarding_oauth_provider_ready_title: 'プロバイダは認証済み',
    onboarding_oauth_provider_ready_body: 'このインスタンスは DiAgent CLI で設定された OAuth プロバイダ (<strong>{provider}</strong>) を使用します。APIキーは不要 — 続けるをクリックしてセットアップを完了してください。',
    ...
    onboarding_api_key_help_prefix: 'DiAgent の .env ファイルにシークレットとして保存されます — 使用変数:',
    ...
    onboarding_workspace_help: 'セットアップ完了後の新規チャットで DiAgent が使用するモデルを選択してください。',
    onboarding_custom_model_placeholder: 'your-model-name',
  ...
  ru: {
    ...
    offline_network_detail: 'DiAgent сейчас недоступен из этого браузера.',
    offline_autorefresh: 'Я автоматически обновлю страницу, когда DiAgent снова станет доступен.',
    ...
    cmd_skills: 'Показать доступные навыки DiAgent',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    logs_file: '文件',
    logs_tail: '尾部行数',
    logs_auto_refresh: '自动刷新（5 秒）',
    logs_wrap: '自动换行',
    logs_copy_all: '复制全部',
    logs_empty: '暂无日志行。',
    logs_loading: '正在加载日志…',
    logs_load_failed: '日志加载失败',
    logs_status_idle: '选择日志文件以查看最近内容。',
    logs_no_mtime: '尚未写入',
    logs_truncated_hint: '正在显示大型日志文件的尾部；为控制内存占用，已跳过更早内容。',
    logs_copied: '日志已复制',
    ...
    settings_desc_sync_insights: 'Синхронизирует использование токенов WebUI в state.db, чтобы DiAgent /insights включал данные браузерных сеансов. Выключено по умолчанию.',
    ...
    settings_desc_bot_name: 'Отображаемое имя помощника во всём интерфейсе. По умолчанию DiAgent.',
    ...
    onboarding_title: 'Добро пожаловать в DiAgent Web UI',
    onboarding_lead: 'Краткая пошаговая настройка проверит DiAgent, сохранит рабочую конфигурацию провайдера, выберет рабочее пространство и модель и при желании защитит приложение паролем.',
    ...
    onboarding_open: 'Открыть DiAgent',
    onboarding_step_system_title: 'Проверка системы',
    onboarding_step_system_desc: 'Проверить DiAgent и видимость конфигурации.',
    onboarding_step_setup_title: 'Настройка провайдера',
    onboarding_step_setup_desc: 'Сохранить минимальную рабочую конфигурацию провайдера DiAgent.',
    ...
    onboarding_notice_system_ready: 'DiAgent, похоже, доступен из Web UI.',
    onboarding_notice_system_unavailable: 'DiAgent ещё не полностью доступен. Bootstrap может установить его, но для настройки провайдера всё ещё может понадобиться терминал.',
    onboarding_check_agent: 'DiAgent',
    ...
    onboarding_notice_setup_required: 'Выберите здесь простой путь настройки провайдера. Продвинутые OAuth-сценарии пока остаются в DiAgent CLI.',
    onboarding_notice_setup_already_ready: 'Уже обнаружена рабочая конфигурация провайдера DiAgent. Вы можете оставить её или заменить здесь.',
    onboarding_oauth_provider_ready_title: 'Провайдер уже авторизован',
    onboarding_oauth_provider_ready_body: 'Этот экземпляр настроен на использование OAuth-провайдера (<strong>{provider}</strong>), настроенного через DiAgent CLI. API-ключ здесь не нужен — нажмите «Продолжить», чтобы завершить настройку.',
    ...
    onboarding_api_key_label_optional: 'API key（可选）',
    onboarding_api_key_placeholder_optional: '无密钥服务器可留空',
    onboarding_api_key_help_keyless: '大多数 LM Studio / Ollama / vLLM 安装默认无密钥运行 — 如果服务器不要求认证，请留空。可使用“测试连接”按钮验证。',
    oauth_login_codex: '使用 Codex（ChatGPT）登录',
    oauth_codex_step1: '第 1 步：访问此 URL 并输入代码',
    oauth_codex_step2: '第 2 步：在页面上输入此代码',
    oauth_codex_polling: '正在等待授权…',
    oauth_codex_success: 'Codex OAuth 登录成功！',
    oauth_codex_error: 'OAuth 登录失败',
    oauth_codex_expired: '代码已过期，请重试',
    onboarding_api_key_help_prefix: 'Сохраняется как секрет в вашем файле `.env` DiAgent с помощью',
    ...
    onboarding_workspace_help: 'Выберите модель, которую DiAgent должен использовать для новых чатов после завершения настройки.',
    ...
    onboarding_probe_ok: '已连接。可用模型 {n} 个。',
    onboarding_probe_error_generic: '无法访问配置的 Base URL。',
    onboarding_probe_error_invalid_url: 'Base URL 必须以 http:// 或 https:// 开头。',
    onboarding_probe_error_dns: '无法解析主机。请检查 URL，或使用主机 IP 地址。',
    onboarding_probe_error_connect_refused: '连接被拒绝 — 服务器可能未在该地址运行。从 Docker 内部访问时，请尝试使用宿主机 IP 而不是 localhost。',
    onboarding_probe_error_timeout: '端点未及时响应。请确认服务器正在运行且 URL 正确。',
    onboarding_probe_error_http_4xx: '端点返回客户端错误。请检查认证和 URL 路径（通常以 /v1 结尾）。',
    onboarding_probe_error_http_5xx: '端点返回服务器错误。请检查 LM Studio / Ollama 服务器日志。',
    onboarding_probe_error_parse: '端点未返回预期格式的模型列表。请确认 URL 指向 OpenAI 兼容 API 根路径。',
    onboarding_probe_error_unreachable: '无法访问配置的 Base URL。',
    onboarding_error_probe_failed: '无法验证配置的 Base URL。',
    ...
    settings_desc_voice_mode: 'Показывать кнопку голосового режима (аудиоволны) рядом с микрофоном диктовки. DiAgent автоматически отправляет реплики после паузы и зачитывает ответы вслух. Требуется браузер с поддержкой распознавания речи и TTS.',
    ...
    checkpoint_date: '日期',
    checkpoint_diff_files_changed: (n) => `${n} 个文件已变更`,
    checkpoint_diff_no_changes: '此检查点与当前工作区之间没有差异。',
    checkpoint_diff_title: '检查点中的变更',
    checkpoint_empty: '此工作区没有检查点。',
    checkpoint_error: '加载检查点失败',
    checkpoint_files: '文件',
    checkpoint_loading: '正在加载检查点…',
    checkpoint_message: '消息',
    checkpoint_restore: '恢复',
    checkpoint_restore_confirm_message: (ckpt) => `将工作区恢复到检查点“${ckpt}”？这会用保存版本覆盖文件。此检查点之后新增的文件不会被删除。`,
    checkpoint_restore_confirm_title: '恢复检查点？',
    checkpoint_restored: '检查点已恢复',
    checkpoint_title: '检查点',
    checkpoint_view_diff: '查看 diff',
    insights_activity_by_day: '按天统计活动',
    insights_activity_by_hour: '按小时统计活动',
    insights_cost: '预估成本',
    insights_daily_tokens: '每日 Token',
    insights_model_name: '模型',
    insights_model_sessions: '会话',
    ...
    insights_peak_hour: '峰值：{hour}',
    insights_sessions: '会话',
    insights_title: '使用分析',
    insights_token_breakdown: 'Token 明细',
    insights_tokens: 'Token',
    insights_total: '总计',
    settings_desc_api_redact: '自托管用户可为透明性关闭此项（共享实例不建议关闭）。',
  ...
  es: {
    ...
    offline_network_detail: 'DiAgent no está disponible desde este navegador ahora mismo.',
    offline_autorefresh: 'Actualizaré esta página automáticamente cuando DiAgent vuelva a estar disponible.',
    ...
    cmd_skills: 'Listar las skills de DiAgent disponibles',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    tab_dashboard: 'Panel de DiAgent',
    ...
    settings_desc_sync_insights: 'Refleja el uso de tokens de la WebUI en state.db para que el comando CLI /insights incluya datos de sesiones del navegador. Desactivado por defecto.',
    ...
    settings_desc_bot_name: 'Nombre visible del asistente en toda la UI. Por defecto es DiAgent.',
    ...
    onboarding_title: 'Bienvenido a DiAgent Web UI',
    onboarding_lead: 'Una guía rápida verificará DiAgent, guardará una configuración real del proveedor, elegirá un espacio de trabajo y un modelo, y opcionalmente protegerá la app con una contraseña.',
    ...
    onboarding_open: 'Abrir DiAgent',
    onboarding_step_system_title: 'Comprobación del sistema',
    onboarding_step_system_desc: 'Verifica DiAgent y la visibilidad de la configuración.',
    onboarding_step_setup_title: 'Configuración del proveedor',
    onboarding_step_setup_desc: 'Guarda la configuración mínima real de DiAgent.',
    ...
    onboarding_notice_system_ready: 'Parece que DiAgent está accesible desde la Web UI.',
    onboarding_notice_system_unavailable: 'DiAgent todavía no está totalmente disponible. Bootstrap puede instalarlo, pero la configuración del proveedor quizá aún requiera una terminal.',
    onboarding_check_agent: 'DiAgent',
    ...
    onboarding_notice_setup_required: 'Elige aquí una ruta simple de proveedor. Los flujos OAuth avanzados siguen siendo del CLI de DiAgent por ahora.',
    onboarding_notice_setup_already_ready: 'Ya se detectó una configuración funcional del proveedor de DiAgent. Puedes conservarla o reemplazarla aquí.',
    onboarding_oauth_provider_ready_title: 'Proveedor ya autenticado',
    onboarding_oauth_provider_ready_body: 'Esta instancia está configurada para usar un proveedor OAuth (<strong>{provider}</strong>) configurado mediante la CLI de DiAgent. No se necesita clave API aquí — haz clic en Continuar para finalizar la configuración.',
    ...
    oauth_codex_error: 'OAuth 登录失败',
    oauth_codex_expired: '代码已过期，请重试',
    onboarding_api_key_help_prefix: 'Se guarda como secreto en tu archivo .env de DiAgent usando',
    onboarding_base_url_label: 'Base URL',
    ...
    onboarding_workspace_help: 'Elige el modelo que DiAgent debe usar para nuevos chats cuando termine la configuración.',
    ...
    // Composer voice-mode pref (#1488)
    settings_label_voice_mode: '免手持语音模式按钮',
    settings_desc_voice_mode: '在听写麦克风旁显示语音模式按钮（音频波形）。你可以自然说话，DiAgent 会在停顿后自动发送并朗读回复。需要浏览器同时支持语音识别和 TTS。',
  ...
  de: {
    ...
    offline_network_detail: 'DiAgent ist von diesem Browser aus gerade nicht erreichbar.',
    offline_autorefresh: 'Ich aktualisiere diese Seite automatisch, sobald DiAgent wieder erreichbar ist.',
    ...
    cmd_skills: 'Verfügbare DiAgent-Skills auflisten',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_desc_sync_insights: 'Spiegelt den WebUI-Token-Verbrauch in die state.db, sodass der CLI-Befehl /insights Browser-Sitzungsdaten enthält. Standardmäßig aus.',
    ...
    settings_desc_bot_name: 'Anzeigename für den Assistenten in der UI. Standardmäßig DiAgent.',
    ...
    onboarding_title: 'Willkommen bei DiAgent',
    ...
    onboarding_step_system_desc: 'DiAgent muss installiert und erreichbar sein.',
    ...
    onboarding_notice_system_unavailable: 'Agent nicht erreichbar. Bitte starten Sie DiAgent.',
  ...
  zh: {
    ...
    offline_network_detail: '此浏览器当前无法连接到 DiAgent。',
    offline_autorefresh: '当 DiAgent 可访问时，我会自动刷新此页面。',
  ...
  folder_add_as_space_title: '\u6dfb\u52a0\u4e3a\u5de5\u4f5c\u533a\uff1f',
    ...
    settings_desc_sync_insights: '将 WebUI token 使用情况同步到 state.db，使 CLI /insights 命令包含浏览器会话数据。默认关闭。',
    settings_desc_check_updates: '当有更新的 WebUI 或助手版本时显示横幅。会在后台定期执行 git fetch。',
    settings_desc_bot_name: '助手在 UI 中的显示名称。默认为 DiAgent。',
    settings_desc_password: '输入新密码以设置或更改。留空保持当前设置。',
    // onboarding
    onboarding_badge: '首次运行',
    onboarding_title: '欢迎使用 DiAgent Web UI',
    archive_extracted: (n, c) => `从 ${c} 个压缩包中解压了 ${n} 个文件`,
    onboarding_lead: '快速引导将验证 DiAgent、保存真实的提供商配置、选择工作区和模型，并可选设置密码保护应用。',
    onboarding_back: '返回',
    onboarding_continue: '继续',
    onboarding_skip: '跳过设置',
    onboarding_skipped: '设置已跳过 — 使用现有配置。',
    onboarding_open: '打开 DiAgent',
    onboarding_step_system_title: '系统检查',
    onboarding_step_system_desc: '验证 DiAgent 与配置可见性。',
    onboarding_step_setup_title: '提供商设置',
    onboarding_step_setup_desc: '保存最小可用的 DiAgent 提供商配置。',
    ...
    onboarding_notice_system_ready: 'DiAgent 看起来可从 Web UI 访问。',
    onboarding_notice_system_unavailable: 'DiAgent 尚未完全可用。Bootstrap 可以安装它，但提供商设置可能仍需要终端。',
    onboarding_check_agent: 'DiAgent',
    ...
    onboarding_notice_setup_required: '请先在此选择一个简单的提供商路径。高级 OAuth 流程暂时仍建议在 DiAgent CLI 中完成。',
    onboarding_notice_setup_already_ready: '已检测到可用的 DiAgent 提供商配置。你可以保留它，或在这里替换。',
    onboarding_oauth_provider_ready_title: '提供商已完成认证',
    onboarding_oauth_provider_ready_body: '此实例已配置为使用通过 DiAgent CLI 设置的 OAuth 提供商（<strong>{provider}</strong>）。这里不需要 API key，点击继续即可完成设置。',
    ...
    oauth_codex_error: 'OAuth 登录失败',
    oauth_codex_expired: '代码已过期，请重试',
    onboarding_api_key_help_prefix: '会作为密钥保存到 DiAgent .env 文件中，变量名为',
    onboarding_base_url_label: 'Base URL',
    onboarding_base_url_placeholder: 'https://your-endpoint.example/v1',
    onboarding_base_url_help: '用于 OpenAI 兼容路由、自托管服务、LiteLLM、Ollama、LM Studio、vLLM 或类似端点。',
    onboarding_model_label: '默认模型',
    onboarding_workspace_help: '选择设置完成后 DiAgent 在新聊天中使用的模型。',
    onboarding_custom_model_placeholder: 'your-model-name',
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_section_preferences_meta: 'DiAgent Web UI 的預設值與介面行為。',
    ...
    settings_desc_sync_insights: '將 WebUI token 使用情況同步到 state.db，使 CLI /insights 命令包含瀏覽器會話數據。預設未啟用。',
    ...
    session_jump_end: '末尾',
    session_jump_end_label: '跳到会话末尾',
    onboarding_api_key_help_prefix: '\u900f\u904e\u4ee5\u4e0b\u65b9\u5f0f\u5132\u5b58\u70ba DiAgent .env \u6a94\u6848\u4e2d\u7684\u6a5f\u5bc6',
    ...
    onboarding_lead: '\u5feb\u901f\u9010\u6b65\u8a2d\u5b9a\uff1a\u6aa2\u67e5 DiAgent\u3001\u5132\u5b58\u63d0\u4f9b\u8005\u914d\u7f6e\u3001\u9078\u64c7\u5de5\u4f5c\u5340\u8207\u6a21\u578b\uff0c\u4e26\u53ef\u9078\u64c7\u52a0\u5165\u5bc6\u78bc\u4fdd\u8b77\u3002',
    ...
    onboarding_notice_setup_already_ready: '\u5df2\u5075\u6e2c\u5230\u53ef\u7528\u7684 DiAgent \u63d0\u4f9b\u8005\u914d\u7f6e\u3002\u60a8\u53ef\u4ee5\u4fdd\u7559\u6216\u5728\u6b64\u53d6\u4ee3\u3002',
    onboarding_notice_setup_required: '\u5728\u6b64\u9078\u64c7\u5feb\u901f\u63d0\u4f9b\u8005\u8a2d\u5b9a\u8def\u5f91\u3002\u9032\u968e OAuth \u8a2d\u5b9a\u4ecd\u8acb\u4f7f\u7528 DiAgent CLI\u3002',
    onboarding_notice_system_ready: 'DiAgent \u53ef\u5f9e Web UI \u5b58\u53d6\u3002',
    onboarding_notice_system_unavailable: 'DiAgent \u5c1a\u672a\u5b8c\u5168\u53ef\u7528\u3002\u5f15\u5c0e\u7a0b\u5f0f\u53ef\u80fd\u5b89\u88dd\u5b83\uff0c\u4f46\u63d0\u4f9b\u8005\u8a2d\u5b9a\u53ef\u80fd\u4ecd\u9700\u7d42\u7aef\u6a5f\u3002',
    ...
    onboarding_oauth_provider_ready_body: '\u6b64\u5be6\u4f8b\u8a2d\u5b9a\u4f7f\u7528\u900f\u904e DiAgent CLI \u914d\u7f6e\u7684 OAuth \u63d0\u4f9b\u8005\uff08<strong>{provider}</strong>\uff09\u3002\u7121\u9700 API \u91d1\u9470 \u2014 \u6309\u7e7c\u7e8c\u5b8c\u6210\u8a2d\u5b9a\u3002',
    onboarding_oauth_provider_ready_title: '\u63d0\u4f9b\u8005\u5df2\u6388\u6b0a',
    onboarding_oauth_switch_hint: '\u6216\u9078\u64c7\u4e0b\u65b9\u5176\u4ed6\u63d0\u4f9b\u8005\u4ee5\u5207\u63db\u5230 API \u91d1\u9470\u8a2d\u5b9a\uff1a',
    onboarding_open: '\u958b\u555f DiAgent',
    ...
    onboarding_step_setup_desc: '\u5132\u5b58\u6700\u5c0f\u53ef\u7528\u7684 DiAgent \u63d0\u4f9b\u8005\u914d\u7f6e\u3002',
    onboarding_step_setup_title: '\u63d0\u4f9b\u8005\u8a2d\u5b9a',
    onboarding_step_system_desc: '\u9a57\u8b49 DiAgent \u8207\u914d\u7f6e\u53ef\u898b\u6027\u3002',
    onboarding_step_system_title: '\u7cfb\u7d71\u6aa2\u67e5',
    onboarding_step_workspace_desc: '\u70ba\u65b0\u6703\u8a71\u9078\u64c7\u9810\u8a2d\u503c\u3002',
    onboarding_step_workspace_title: '\u5de5\u4f5c\u5340\u8207\u6a21\u578b',
    onboarding_title: '\u6b61\u8fce\u4f7f\u7528 DiAgent Web UI',
    onboarding_unknown: '\u672a\u77e5',
    onboarding_workspace_help: '\u9078\u64c7 DiAgent \u5728\u8a2d\u5b9a\u5b8c\u6210\u5f8c\u7528\u65bc\u65b0\u804a\u5929\u5ba4\u7684\u6a21\u578b\u3002',
    ...
    status_profile: '個人資料',
    status_hermes_home: 'DiAgent 主目錄',
    status_started: '開始時間',
    status_tokens: 'Token',
    status_updated: '已更新',
  ...
  pt: {
    ...
    offline_network_detail: 'O DiAgent está inacessível neste navegador agora.',
    offline_autorefresh: 'Vou atualizar esta página automaticamente quando o DiAgent voltar a responder.',
    ...
    cmd_skills: 'Listar skills disponíveis do DiAgent',
    ...
    status_hermes_home: 'Diretório DiAgent',
    ...
    settings_section_preferences_meta: 'Padrões e comportamento UI do DiAgent Web UI.',
    ...
    settings_desc_bot_name: 'Nome de exibição do assistente. Padrão: DiAgent.',
    ...
    onboarding_title: 'Bem-vindo ao DiAgent Web UI',
    onboarding_lead: 'Uma configuração rápida vai verificar DiAgent, salvar provedor, escolher workspace e modelo, e opcionalmente proteger com senha.',
    ...
    onboarding_step_system_desc: 'Verificar DiAgent e visibilidade da config.',
    onboarding_step_setup_title: 'Configuração do provedor',
    onboarding_step_setup_desc: 'Salvar config mínima do provedor DiAgent.',
    ...
    onboarding_notice_system_ready: 'DiAgent parece acessível pela Web UI.',
    onboarding_notice_system_unavailable: 'DiAgent não está totalmente disponível. Bootstrap pode instalar, mas setup do provedor pode requerer terminal.',
    onboarding_check_agent: 'DiAgent',
    ...
    onboarding_notice_setup_required: 'Escolha caminho simples de provedor aqui. OAuth avançado ainda pertence ao DiAgent CLI.',
    onboarding_notice_setup_already_ready: 'Setup de provedor DiAgent já detectado. Pode manter ou substituir.',
    ...
    onboarding_api_key_placeholder_optional: '无密钥服务器可留空',
    onboarding_api_key_help_keyless: '大多数 LM Studio / Ollama / vLLM 安装默认无密钥运行 — 如果服务器不要求认证，请留空。可使用“测试连接”按钮验证。',
    onboarding_api_key_help_prefix: 'Salvo como segredo no .env do DiAgent usando',
    onboarding_base_url_label: 'Base URL',
    ...
    onboarding_workspace_help: 'Escolha modelo que DiAgent deve usar para novos chats.',
  ...
  ko: {
    ...
    offline_network_detail: '현재 이 브라우저에서 DiAgent에 연결할 수 없습니다.',
    offline_autorefresh: 'DiAgent에 다시 연결되면 이 페이지를 자동으로 새로고침합니다.',
    ...
    settings_section_preferences_meta: 'DiAgent Web UI의 기본값과 UI 동작.',
    ...
    onboarding_lead: '간단한 안내 설정으로 DiAgent 설치를 확인하고, 워크스페이스와 모델을 선택하며, 필요하면 비밀번호로 앱을 보호합니다.',
    onboarding_back: '뒤로',
