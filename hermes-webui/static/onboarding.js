const ONBOARDING={status:null,step:0,steps:['system','setup','workspace','password','finish'],form:{provider:'yice',workspace:'',model:'',password:'',apiKey:'',baseUrl:'https://yice.byd.com/ai-gate/v1'},active:false,probe:{status:'idle',error:null,detail:'',models:null,probedKey:''}};
